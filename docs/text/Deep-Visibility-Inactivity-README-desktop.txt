Deep Visibility Inactivity – README (Deutsch)
...
Das Skript:
	...
	•	konzentriert sich auf den lokalen Agentenstatus und die Netzwerkverbindung zum Deep-Visibility-Gateway
...
Sie haben per Mail bereits Folgendes erhalten:
...
4.1. Auf einem einzelnen Endpunkt
	•	Kopieren Sie S1-DeepVisibility-PassiveDiag.ps1 auf den Endpunkt.
	•	Öffnen Sie PowerShell als Administrator.
	•	Navigieren Sie zum Ordner mit dem Skript, indem Sie folgenden Befehl ausführen: cd C:\Users\Public\Downloads 
...
5.1. Agenten- und Systemstatus
	...
	•	Letzte Boot-Zeit
	•	Zeitzone
5.2. Deep-Visibility-Konfiguration
...
5.3. Netzwerk- und TLS-Konnektivität
...
5.4. Proxy- und Firewall-Kontext
	•	WinHTTP-Proxy
...
5.5. Agent-Logs und aktive Netzwerkverbindungen
	•	Prüft Log-Ordner:
...
7.1. Agent-Dienst not running(CRITICAL)
Beispielantwort:
...
7.3. TCP-Port 443 blockiert (CRITICAL)
...
7.4. Proxy-Authentifizierung erforderlich – HTTP 407 (CRITICAL)
...
Was Sie machen können:
	...
	•	Wenn das Problem bleibt: Neuinstallation oder Upgrade des Agenten in Betracht ziehen.

7.6. Netzwerkquarantäne aktiv (WARNING)
...
7.7. TLS-Test fehlgeschlagen (INFO)
...
7.8. DV-Konfiguration fehlt in der Registry (INFO)
...
QGroup SecOps kontaktieren und übermitteln:
